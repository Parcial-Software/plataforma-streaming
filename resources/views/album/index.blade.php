    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <main id="page_content">
                ...
                <div class="container under-hero">
                    ...
                    <div class="section">
                        <div class="section__head">
                            <h3 class="mb-0 text-3xl">Mejores<span class="text-primary"> Albums</span></h3>
                        </div>
                                            ...
                                            <div class="cover__head">
                                                ...
                                                <div class="cover__options dropstart d-inline-flex ms-auto">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-sm">
                                                        <li><a class="dropdown-item" href="javascript:void(0);" role="button" data-favorite-id="100">Favorito</a>
                                                        </li>
                                                        <li><a class="dropdown-item" href="{{ $album['imageUrl'] }}" download>Descargar</a></li>
                                                        <li><a class="dropdown-item" href="javascript:void(0);" role="button">Compartir</a></li>
                                                        <li class="dropdown-divider"></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <a href="#" class="cover__image">
                                                <img src="{{ $album['imageUrl'] }}" alt="{{ $album['name'] }}" style="width: 200px; height: 200px;">
                                            </a>
                                            <div class="cover__foot">
                                                <a href="album-details.html" class="cover__title text-truncate">{{ $album['name'] }}</a>
                                            </div>
                                        </div>
                                        <!-- End:: cover -->
                                    </div>
                    ...
                    <div class="section">
                        <div class="section__head">
                            <h3 class="mb-0 text-2xl">Mis<span class="text-primary"> Albums</span></h3>
                        </div>
                        <!-- Start:: swiper carousel [[ Find at scss/components/swiper.scss ]] -->
                        <div class="swiper-carousel swiper-carousel-button">
                            <!-- Start:: swiper [[ Find at scss/components/swiper.scss ]] -->
                            <div class="swiper" id="userAlbumsSwiper" data-swiper-slides="5" data-swiper-autoplay="true">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="cover cover--round">
                                            ...
                                            <a href="album-details.html" class="cover__image">
                                                <img src="{{ $userAlbum['imageUrl'] }}" alt="{{ $userAlbum['name'] }}" style="width: 200px; height: 200px;">
                                            </a>
                                            <div class="cover__foot">
                                                <a href="album-details.html" class="cover__title text-truncate">{{ $userAlbum['name'] }}</a>
                                            </div>
                                        </div>
                                        <!-- End:: cover -->
                                    </div>
                        ...
                        <!-- Swiper controls -->
                        <div class="swiper-button-next btn-default rounded-pill" onclick="prevSwiper('userAlbumsSwiper')"></div>
                        <div class="swiper-button-next btn-default rounded-pill" onclick="nextSwiper('userAlbumsSwiper')"></div>
                    </div>
                </div>
                <!-- End:: section -->
                ...
                <div class="section">
                    <div class="section__head">
                        <h3 class="mb-0 text-2xl">Las<span class="text-primary"> Canciones mas Populares</span></h3>
                    </div>
